# Generated by Django 5.1.5 on 2025-03-20 03:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base', '0003_rename_project_link_project_link_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('applied', 'Applied'), ('rejected', 'Rejected'), ('selected', 'Selected'), ('interviewing', 'Interviewing'), ('offered', 'Offered'), ('withdrawn', 'Withdrawn')], default='applied', max_length=20)),
