        ...
        <div className="h-full w-full text-[#ffffff] bg-[#030712]">
            ...
            <div className="flex border-b-2 border-[#364153]">
                ...
                <div className="text-[#ffffff] bg-[#030712] flex justify-center items-center w-[60%] p-8">
                    ...
                    {/* Header Section */}
                    <div className="text-center mb-4 pb-3 border-b-2 border-[#2563eb]">
                        <h2 className="text-3xl font-bold text-[#1e40af] mb-1">{name}</h2>
                    ...
                    <div className="flex gap-4">
                        ...
                        {/* Experience */}
                        <div className="mb-4">
                            <h3 className="text-lg font-bold text-[#1e40af] mb-2 pb-1 border-b border-[#e5e7eb]">
                            EXPERIENCE
                            </h3>
                            {experience.map((exp, index) => (
                            <div key={index} className="mb-3">
                                ...
                                <p className="text-xs text-[#2563eb] font-semibold mb-1">{exp.company}</p>
                                <p className="text-xs text-[#4b5563] leading-relaxed">{exp.description}</p>
                            </div>
                            ))}
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <div key={index} className="mb-2">
                                <h4 className="font-bold text-sm text-[#2563eb] underline">
                        ...
                        <div className="mb-4">
                            ...
                            {skills.map((skill, index) => (
                                <span
                                key={index}
                                className="text-xs bg-[#eff6ff] text-[#1e40af] px-2 py-1 rounded-full border border-[#bfdbfe]"
                                >
                                {skill}
                                </span>
                            ))}
                        ...
                        <div>
                            ...
                            <div key={index} className="mb-3">
                                ...
                                <p className="text-xs text-[#2563eb]">{edu.field_of_study}</p>
